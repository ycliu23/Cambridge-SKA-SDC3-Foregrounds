...
The Fourier modes that are dominated by the intrinsic and instrumentally corrupted foregrounds are also masked in the resultant cylindrical power spectra based on a foreground avoidance strategy:
