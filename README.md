...
## OSKAR Simulation
The first step is to remove the point sources in the SKA SDC3 data by simulating with the [OSKAR simulator](https://github.com/OxfordSKA/OSKAR).
